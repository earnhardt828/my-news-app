...
export const LOCAL_CITY_CONFIGS: Record<string, LocalCityConfig> = {
  ...
  "Austin, TX": {
    ...
    strictTerms: ["austin", "travis county", "central texas", "texas", "tx"],
    rssFeeds: [
      "KXAN Austin",
      "KVUE Austin",
      "FOX 7 Austin",
  ...
  "San Antonio, TX": {
    ...
    rssFeeds: ["KSAT San Antonio", "KENS5 San Antonio", "Texas Public Radio San Antonio"],
  },
  "San Diego, CA": {
    cityKey: "san-diego-ca",
    city: "San Diego",
    state: "CA",
    ...
    strictTerms: ["san diego", "san diego county", "california", "ca"],
    rssFeeds: [
      "NBC 7 San Diego",
      "ABC 10News San Diego",
      "CBS 8 San Diego",
  ...
  "Jacksonville, FL": {
    ...
    strictTerms: ["jacksonville", "duval county", "first coast", "florida", "fl"],
    rssFeeds: [
      "News4JAX",
      "First Coast News Jacksonville",
      "Action News Jax",
  ...
  "Dallas, TX": {
    ...
    strictTerms: ["dallas", "dallas county", "fort worth", "dfw", "texas", "tx"],
    rssFeeds: [
      "Dallas Morning News",
      "WFAA Dallas",
      "NBC 5 Dallas-Fort Worth",
